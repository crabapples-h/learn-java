...
`cn.crabapples:learn-java`，Java 11，Spring Boot 2.6.13，Spring Cloud 2021.0.4，Spring Cloud Alibaba 2021.0.4.0。Reactor 模块：learn、design-pattern、frontend、plugins、learn-byte-buddy、module-base-core、modules、modules-application。
...
- `.mimocode/bug-fix-plan-123.md` — 前端 3 个 bug 修复方案（已完成，见 BUG.md）
