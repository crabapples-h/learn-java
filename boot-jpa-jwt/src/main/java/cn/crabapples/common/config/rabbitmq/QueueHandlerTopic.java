...
@Slf4j
//@Component
public class QueueHandlerTopic {

    @RabbitListener(queues = RabbitTopicConfigure.QUEUE_NAME)
    @RabbitHandler
     ...
     */
    @RabbitListener(queues = RabbitTopicConfigure.QUEUE_NAME,concurrency = "20")
    @RabbitHandler
