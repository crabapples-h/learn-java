package cn.crabapples.common.config.datasource.aop;
...
public class DynamicDataSourceRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    private final Map<String, DataSource> dataSourceMaps = new HashMap<String, DataSource>();
    ...
    private DataSource buildDataSource(Map<String, Object> dataSourceMap) {
        log.info("开始构建数据源:[{}]", dataSourceMap);
        try {
