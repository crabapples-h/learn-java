...
public class PlyShop {
    private static final Logger logger = LoggerFactory.getLogger(PlyShop.class);

    public static void main(String[] args) {
        SpringApplication.run(PlyShop.class, args);
        logger.info(">>>>>>>>PlyShop服务启动成功 [nacos] [jpa] [shiro] >>>>>>>>>");
    }
    @Bean
