<template>
  <div>
    ...
    <a-divider />
    <depart-detail :open="show.detail" :dict-code="dictCode" @cancel="closeDetail" />
    <add-depart :open="show.add" @close="closeAdd" />
    <add-depart :open="show.edit" @close="closeEdit" :is-edit="true" :edit-data="editData" />
...
import AddDepart from './add.vue'
import DepartDetail from './detail.vue'
