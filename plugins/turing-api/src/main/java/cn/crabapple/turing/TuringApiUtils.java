...
public class TuringApiUtils {
    private static final Logger logger = LoggerFactory.getLogger(TuringApiProperties.class);

    private final RestTemplate restTemplate = new RestTemplate();
    private final TuringApiProperties turingApiProperties;

    public TuringApiUtils(TuringApiProperties turingApiProperties) {
        this.turingApiProperties = turingApiProperties;
    }
    ...
    public String sendToTuringApi(String requestString) {
        ResponseEntity<String> responseEntity = restTemplate.postForEntity(turingApiProperties.getUrl(), createTuringRequestDTO(requestString).toString(), String.class);
    ...
    private TuringRequestDTO createTuringRequestDTO(String text) {
        ...
        userInfo.setApiKey(turingApiProperties.getAppKey());
