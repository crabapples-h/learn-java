...
import crabapples.config.RpcConfigure;
...
public class TestController {
    ...
    public void client(@PathVariable String content) {
        ...
        Message result = rabbitTemplate.sendAndReceive(RpcConfigure.EXCHANGE_NAME, RpcConfigure.ROUTING_KEY, message);
    ...
    public void server(Channel channel, Message message) throws IOException {
        ...
        rabbitTemplate.sendAndReceive(RpcConfigure.EXCHANGE_NAME, RpcConfigure.ROUTING_KEY2, replyMessage, correlationData);
